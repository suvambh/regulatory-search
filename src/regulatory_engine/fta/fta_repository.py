...
def find_legal_basis(
    ...
    """
    Retrieve the intentionally ingested legal
    provisions for an agreement.
    """
...
def find_origin_rule(
    ...
    """
    Retrieve the product-specific origin rule.

    Origin-rule tables used by this prototype
    are indexed at HS4 level.
    """
